...
let ChatController = class ChatController {
    ...
    chatRoomHandler(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { clientId, freelancerId } = req.body;
                const chatRoom = yield this._chatService.chatRoom(clientId, freelancerId);
    ...
    getAllChatRooms(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const chatRooms = yield this._chatService.getAllChatRooms(id);
