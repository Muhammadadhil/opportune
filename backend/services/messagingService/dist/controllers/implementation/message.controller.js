...
let MessageController = class MessageController {
    ...
    sendMessageHandler(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const message = yield this._messageService.sendMessage(senderId, receiverId, content, chatRoomId);
    ...
    // get chat history
    getMessagesHandler(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { chatRoomId } = req.params;
                const messages = yield this._messageService.getMessages(chatRoomId);
