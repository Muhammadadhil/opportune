...
const SOCKET_URL = import.meta.env.VITE_NODE_ENV != "production" ? `ws://${import.meta.env.VITE_NOTIFICATION_SOCKET_URL}` : `wss://${import.meta.env.VITE_NOTIFICATION_SOCKET_URL}`;
